...
// export function check(_values: AntdButtonPreviewProps): Problem[] {
...
// export function getPreview(values: AntdButtonPreviewProps, isDarkMode: boolean): PreviewProps {
...
// export function getCustomCaption(values: AntdButtonPreviewProps, platform: Platform): string {
//     return "AntdButton";
// }
